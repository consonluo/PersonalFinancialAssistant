...
final totalLiabilityProvider = Provider<double>((ref) {
  ...
  final financing = ref.watch(accountFinancingLiabilityProvider);
  final manualLiability =
      liabilities.fold(0.0, (sum, l) => sum + l.remainingAmount);
  return manualLiability + financing;
});
